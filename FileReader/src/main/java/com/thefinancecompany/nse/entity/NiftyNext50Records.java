...
public class NiftyNext50Records {
	...
	public NiftyNext50Records(){}
	public NiftyNext50Records(String symbol, double open, double high, double low, double previous,
			double lastTradingPoint, double change, double changePercentage, double volume, double value,
			double _52WeekHigh, double _52WeekLow, double yearlyChange, double monthlyChange,
			LocalDateTime insertedDateTime) {
		this.symbol = symbol;
		this.open = open;
		this.high = high;
		this.low = low;
	...
	public String toString() {
		return "NiftyNext50Records [dbId=" + dbId + ", symbol=" + symbol + ", open=" + open + ", high=" + high
				+ ", low=" + low + ", previous=" + previous + ", lastTradingPoint=" + lastTradingPoint + ", change="
				+ change + ", changePercentage=" + changePercentage + ", volume=" + volume + ", value=" + value
				+ ", _52WeekHigh=" + _52WeekHigh + ", _52WeekLow=" + _52WeekLow + ", yearlyChange=" + yearlyChange
				+ ", monthlyChange=" + monthlyChange + ", insertedDateTime=" + insertedDateTime + "]";
	}
}
